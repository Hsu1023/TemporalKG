...
class KGGenerator_randomWalks:
    ...
    @staticmethod
    def multi_starts_random_walk_induced_graph_sampling(complete_graph, nodes_to_sample, num_starts, p=1):
        complete_graph = nx.convert_node_labels_to_integers(complete_graph, 0, 'default', True)
...
def generate(args):
    ...
    if isinstance(args, dict):
        args.setdefault('dataset', 'wn18rr')
        args.setdefault('data_path', './dataset/')
        args.setdefault('sample_ratio', 0.2)
        args.setdefault('repeat', 0)
        args.setdefault('num_starts', 10)
    ...
    print('dataset:', datasetInfo['datasetName'], 'nentity', datasetInfo['nentity'], 'nrelation', datasetInfo['nrelation'])
